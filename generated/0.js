...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(appSettings, builder, customerService, router, route, toastr, store) {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.customerService.login(this.userForm.value).subscribe(function (data) {
            _this.store.dispatch(new _core_actions_user__WEBPACK_IMPORTED_MODULE_7__["UpdateUser"](data));
