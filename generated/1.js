...
/* harmony import */ var src_app_customer_services_customer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/customer/services/customer */ "./src/app/customer/services/customer.ts");
...
/* harmony import */ var src_app_shared_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/shared/utils */ "./src/app/shared/utils.ts");
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(productService, customerService, appSettings, store, toastr, router, route, builder) {
        var _this = this;
        this.productService = productService;
        ...
        this.deliveryForm = this.builder.group({
            first_name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            last_name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            city: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            postal_code: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            country: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            address_1: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            address_2: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            region: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            shipping_region: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required],
            shipping: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required]]
        });
        this.order = {
            status: 0,
            shipping: 1
        ...
        this.paymentForm = this.builder.group({
            ...
            credit_card: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].pattern('^[0-9]{16}$')]],
            cvv: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].pattern('^[0-9]{3}$')]],
            expiry_date: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_12__["Validators"].required, function (control) {
        ...
        this.store.select(_reducers__WEBPACK_IMPORTED_MODULE_6__["selectAllCartItems"]).subscribe(function (items) {
            _this.cartItems = items;
        });
        ...
        this.getPrice = src_app_shared_utils__WEBPACK_IMPORTED_MODULE_14__["getPrice"];
    }
    CheckoutComponent.prototype.ngOnInit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["forkJoin"])(this.productService.loadShippings(), this.customerService.getShippingRegions()).subscribe(function (data) {
            if (data) {
                _this.shippings = data[0];
                _this.shipping_regions = data[1];
                _this.store.select(_core_reducers__WEBPACK_IMPORTED_MODULE_5__["selectorUser"]).subscribe(function (cust) {
                    if (cust) {
                        _this.customer = cust;
                        var values = {
    ...
    CheckoutComponent.prototype.pay = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["forkJoin"])(this.customerService.saveProfile(this.customer), this.productService.createOrder(this.order)).subscribe(function (data) {
            _this.store.dispatch(new _core_actions_user__WEBPACK_IMPORTED_MODULE_8__["UpdateUser"](data[0]));
            _this.order = data[1];
    ...
    CheckoutComponent.prototype.totalPrice = function () {
        return Object(src_app_shared_utils__WEBPACK_IMPORTED_MODULE_14__["totalPrice"])(this.cartItems);
    };
    ...
    CheckoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"],
            src_app_customer_services_customer__WEBPACK_IMPORTED_MODULE_11__["CustomerService"],
            src_app_app_constant__WEBPACK_IMPORTED_MODULE_4__["AppSettings"],
            _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"],
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../actions */ "./src/app/product/actions/index.ts");
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../reducers */ "./src/app/product/reducers/index.ts");
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(productService, router, route, appSettings, store) {
        this.productService = productService;
        this.router = router;
        this.route = route;
        this.appSettings = appSettings;
    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        this.store.select(_reducers__WEBPACK_IMPORTED_MODULE_7__["isCartLoaded"]).subscribe(function (value) {
        ...
        this.productService.addToCart(item).subscribe(function (item) {
            if (_this.isCartLoaded) {
                if (item.quantity > 1) {
                    ...
                    _this.store.dispatch(new _actions__WEBPACK_IMPORTED_MODULE_6__["AddCartItem"](item));
                }
            }
        });
    };
...
/* harmony import */ var src_app_core_services_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/events */ "./src/app/core/services/events.ts");
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(store, eventService, productService, router, route) {
        var _this = this;
        this.store = store;
    ...
    ProductsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["Store"],
            src_app_core_services_events__WEBPACK_IMPORTED_MODULE_4__["EventService"],
